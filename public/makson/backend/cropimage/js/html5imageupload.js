...
(function (window, $, undefined) {
	...
	$.html5imageupload = function html5imageupload(options, element) {
		...
		this.button.saving		= '<div class="btn btn-warning saving">' + (this.options.saveLabel || 'Saving...') + ' <i class="fa fa-time"></i></div>';
		this.button.zoomin		= '<div class="btn btn-primary btn-zoom-in" title="' + (this.options.zoominTitle || 'Zoom in') + '"><i class="fa fa-zoom-out"></i></div>';
		this.button.zoomout		= '<div class="btn btn-primary btn-zoom-out" title="' + (this.options.zoomoutTitle || 'Zoom out') + '"><i class="fa fa-zoom-in"></i></div>';
		this.button.zoomreset	= '<div class="btn btn-primary btn-zoom-reset" title="' + (this.options.zoomresetTitle || 'Fullsize') + '"><i class="fa fa-zoom-out"></i></div>';
//		this.button.rotatecw	= '<div class="btn btn-default btn-rotate-cw" title="' + (this.options.cwTitle || 'Rotate clockwise') + '"><i class="fa fa-share"></i></div>';
//		this.button.rotateccw	= '<div class="btn btn-default btn-rotate-ccw" title="' + (this.options.ccwTitle || 'Rotate counter clockwise') + '"><i class="fa fa-share icon-flipped"></i></div>';
		this.button.cancel		= '<div class="btn btn-danger btn-cancel" title="' + (this.options.cancelTitle || 'Cancel') + '"><i class="fa fa-remove"></i></div>';
		this.button.done		= '<div class="btn btn-success btn-ok" title="' + (this.options.okTitle || 'Ok') + '"><i class="fa fa-check"></i></div>';
		this.button.del			= '<div class="btn btn-danger btn-del" title="' + (this.options.delTitle || 'Delete') + '"><i class="fa fa-trash"></i></div>';
		
		this.button.download	= '<a class="btn btn-warning download"><i class="fa fa-download"></i> ' + (this.options.downloadLabel || 'Download') + '</a>';
