...
(function( $ ) {
  $.fn.fadeloader = function(options) {
		...
		if(opts.preloadCustom === '') {
			loaderImg = '<div class="preloader d-flex justify-content-center d-flex align-items-center" style=""><img src="'+opts.preloadImg+'" border="0" width="'+opts.preloadWidth+'" height="'+opts.preloadHeight+'" /></div>';
		}
