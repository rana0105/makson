            ...
            <div class="page-header float-right">
                <div class="page-title">
                    <ol class="breadcrumb text-right">
                        ...
                        <li><a href="<?php echo e(route('cstatus.index')); ?>">Compliance Status</a></li>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                          <form action="<?php echo e(route('cstatus.store')); ?>" method="POST" enctype="multipart/form-data" file="true">
