                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title"><a href="<?php echo e(route('clientele.create')); ?>">Create</a></strong>
                        </div>
                        <div class="card-body">
                            <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    <td><?php echo e($clientele->title); ?></td>
                                    <td>
                                        <img src="<?php echo e(asset('/uploads/'. $clientele->logo)); ?>" alt="<?php echo e($clientele->logo); ?>" width="40" height="40" class="img img-thumbnail">
                                    </td>
                                    <td>

                                        <a href="<?php echo e(route('clientele.edit', $clientele->id)); ?>">
                                            <button class="btn btn-style btn-small btn-info"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button>
                                        </a>
                                        <?php echo Form::open(['route' => ['clientele.destroy', $clientele->id ], 'method' => 'DELETE', 'class'=>'delete_form', 'style'=>'display:inline' ]); ?>
