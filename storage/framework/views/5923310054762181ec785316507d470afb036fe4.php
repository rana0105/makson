                  ...
                  <div class="row margin-o">
                    ...
                    <div class="col-md-6 padding-o">
                      <div class="single-item-report-right overflow-fix d-flex justify-content-end">
                        <div class="icon-print"><a href="<?php echo e(asset('/storage/'. $mreport->file)); ?>"><i class="fas fa-print"></i><span>Print</span></a></div>
                        <div class="download-print"><a href="<?php echo e(asset('/storage/'. $mreport->file)); ?>"><i class="fas fa-download"></i><span>Download</span></a></div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                ...
                <div class="tab-single-item-report overflow-fix">
                  <div class="row margin-o">
                    ...
                    <div class="col-md-6 padding-o">
                      <div class="single-item-report-right overflow-fix d-flex justify-content-end">
                        <div class="icon-print"><a href="<?php echo e(asset('/storage/'. $mereport->file)); ?>"><i class="fas fa-print"></i><span>Print</span></a></div>
                        <div class="download-print"><a href="<?php echo e(asset('/storage/'. $mereport->file)); ?>"><i class="fas fa-download"></i><span>Download</span></a></div>
                      </div>
                    </div>
                  </div>
                </div>
