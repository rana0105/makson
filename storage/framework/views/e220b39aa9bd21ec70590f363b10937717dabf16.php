                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title"><a href="<?php echo e(route('slider.create')); ?>">Create</a></strong>
                        </div>
                        <div class="card-body">
                            <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td><?php echo str_limit(strip_tags($slider->description), 30); ?>

                                    </td>
                                    <td>
                                        <img src="<?php echo e(asset('/uploads/'. $slider->image)); ?>" alt="<?php echo e($slider->image); ?>" width="40" height="40" class="img img-thumbnail">
                                    </td>
                                    <td>
                                        ...
                                        <?php echo Form::open(['route' => ['slider.destroy', $slider->id ], 'method' => 'DELETE', 'class'=>'delete_form', 'style'=>'display:inline' ]); ?>
