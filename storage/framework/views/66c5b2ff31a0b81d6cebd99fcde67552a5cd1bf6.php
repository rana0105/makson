...
<div id="preloader">
      <div class="d-flex justify-content-center align-items-center" id="status">
        <div class="status-img overflow-fix"><img src="<?php echo e(asset('makson/images/loder.gif')); ?>" alt=""></div>
      </div>
    </div>
  ...
  <div class="responsive-menu-area overflow-fix">
    <div class="container">
      <div class="row">
        ...
        <div class="logo-area overflow-fix"><a href=""><img src="<?php echo e(asset('makson/images/logo.gif')); ?>" alt=""></a></div>
        </div>
        <div class="col-sm-8 col-4 ">
          ...
          <div class="responsive-menu-slinky"> 
            ...
            <li><a href="#">About us</a>
              <ul>
              <li><a href="<?php echo e(url('at-a-glance')); ?>">Maksons at a Glance</a></li>
              <li><a href="<?php echo e(url('history')); ?>">History</a></li>
              <li><a href="<?php echo e(url('mission-vision')); ?>">Mission & Vision</a></li>
              <!--<li><a href="<?php echo e(url('board-of-director')); ?>">Board Of Director's</a></li>-->
              <li><a href="<?php echo e(url('meet-people')); ?>">Meet Our People</a></li>
              <li><a href="<?php echo e(url('recognition')); ?>">Awards and Recognition</a></li>
              </ul>
            </li>
            <li><a href="#">Group Concerns</a>
              <ul>
                <li><a href="<?php echo e(url('maksons-spinning-mills-ltd')); ?>">Maksons Spinning Mills Ltd</a></li>
                <li><a href="<?php echo e(url('metro-spinning-ltd')); ?>">Metro Spinning Ltd</a></li>
                <li><a href="<?php echo e(url('maksons-textile-limited')); ?>">Maksons Textile Ltd</a></li>
                <li><a href="<?php echo e(url('makcot-international')); ?>">Makcot International</a></li>
                <li><a href="<?php echo e(url('lamuni-apparels-ltd')); ?>">Lamuni Apparels Ltd</a></li>
                <li><a href="<?php echo e(url('maksourcing-ltd')); ?>">Mak Sourcing Limited</a></li>
                <li><a href="<?php echo e(url('maksons-properties-development-ltd')); ?>">Maksons Properties & Development Limited</a></li>
                <li><a href="<?php echo e(url('maksons-logistic-ltd')); ?>">Maksons Logistic Ltd</a></li>
              </ul>
            </li>
            <li><a href="#">Investor</a>
              <ul>
                <li><a href="<?php echo e(url('major-share-holding')); ?>">Major Share holding</a></li>
                <li><a href="<?php echo e(url('annual-reports')); ?>">Annual Reports</a></li>
                <li><a href="<?php echo e(url('compliance-status')); ?>">Compliance Status</a></li>
                <li><a href="<?php echo e(url('quarterly-reports')); ?>">Quarterly Reports</a></li>
                <li><a href="<?php echo e(url('director-report')); ?>">Director Reports</a></li>
              </ul>
            </li>
    ...
    <div class="single-logo-area overflow-fix d-flex align-items-center justify-content-end">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            <div class="single-logo header-tilt overflow-fix"><img src="<?php echo e(asset('makson/images/blogo.png')); ?>" alt=""></div>
          </div>
        </div>
      </div>
    </div>
  ...
  Wishing and praying for a better tomorrow.
        ...
        <div class="col-lg-4  col-md-5 col-sm-12">
          <div class="new-person-right-area">
            ...
            <img src="<?php echo e(asset('makson/images/per.png')); ?>" alt=""/>
          </div>
        </div>
      ...
      <div class="col-lg-12">
        ...
        <div class="new-concerns-slider  owl-carousel owl-theme overflow-fix">
          ...
          <div class="new-concerns-slider-single overflow-fix">
            <img class="bg-img-concerns" src="<?php echo e(asset('/uploads/'. $concern->image)); ?>" alt=""/>
            <div class="new-concerns-slider-content overflow-fix">
              <div class="new-concerns-slider-content-m overflow-fix">
                <img src="<?php echo e(asset('/uploads/'. $concern->logo)); ?>" alt=""/>
                <img src="<?php echo e(asset('/uploads/'. $concern->on_hover_logo)); ?>" alt=""/>
    ...
    <section class="chronology-main-area overflow-fix">
      <div class="container">
        <div class="row">
          ...
          <img src="<?php echo e(asset('makson/images/grid-1.jpg')); ?>" alt="">
        </div>
                <div class="chronology-mdl-grid-single-item overflow-fix">
          <img src="<?php echo e(asset('makson/images/grid-2.jpg')); ?>" alt="">
        </div>
              </div>
              <div class="chronology-mdl-grid overflow-fix">
                <div class="chronology-mdl-grid-single-item overflow-fix">
          <img src="<?php echo e(asset('makson/images/grid-3.jpg')); ?>" alt="Title">
        </div>
                <div class="chronology-mdl-grid-single-item overflow-fix">
          <img src="<?php echo e(asset('makson/images/grid-4.jpg')); ?>" alt="Title">
        </div>
              </div>
              <div class="chronology-mdl-grid overflow-fix">
                <div class="chronology-mdl-grid-single-item overflow-fix">
          <img src="<?php echo e(asset('makson/images/grid-5.jpg')); ?>" alt="Title">
        </div>
              </div>
            </div>
          </div>
          ...
          <img src="<?php echo e(asset('makson/images/grid-6.jpg')); ?>" alt="Title">
        </div>
              </div>
              <div class="chronology-right-grid overflow-fix">
                <div class="chronology-right-grid-single-item overflow-fix">
          <img src="<?php echo e(asset('makson/images/grid-7.jpg')); ?>" alt="Title">
        </div>
                <div class="chronology-right-grid-single-item overflow-fix">
          <img src="<?php echo e(asset('makson/images/grid-8.jpg')); ?>" alt="Title">
        </div>
              </div>
              <div class="chronology-right-grid overflow-fix">
                <div class="chronology-right-grid-single-item overflow-fix">
          <img src="<?php echo e(asset('makson/images/grid-9.jpg')); ?>" alt="Title">
        </div>
                <div class="chronology-right-grid-single-item overflow-fix">
          <img src="<?php echo e(asset('makson/images/grid-10.jpg')); ?>" alt="Title">
        </div>
              </div>
            </div>
          </div>
                ...
                <div class="col-lg-6">
                    <div class="authority-left-area owl-carousel owl-theme overflow-fix">
                        <div class="row margin-o">
                            <div class="col-lg-4">
                              <div class="authority-left-single-img overflow-fix"><img src="<?php echo e(asset('makson/images/Capture.PNG')); ?>" alt="Title"></div>
                            </div>
                            <div class="col-lg-4">
                              <div class="authority-left-single-img overflow-fix"><img src="<?php echo e(asset('makson/images/Capture2.PNG')); ?>" alt="Title"></div>
                            </div>
                            <div class="col-lg-4">
                              <div class="authority-left-single-img overflow-fix"><img src="<?php echo e(asset('makson/images/Capture3.png')); ?>" alt="Title"></div>
                            </div>
                            <div class="col-lg-4">
                              <div class="authority-left-single-img overflow-fix"><img src="<?php echo e(asset('makson/images/Capture4.png')); ?>" alt="Title"></div>
                            </div>
                            <div class="col-lg-4">
                              <div class="authority-left-single-img overflow-fix"><img src="<?php echo e(asset('makson/images/Capture5.png')); ?>" alt="Title"></div>
                            </div>
                            <div class="col-lg-4">
                              <div class="authority-left-single-img overflow-fix"><img src="<?php echo e(asset('makson/images/Capture6.png')); ?>" alt="Title"></div>
                            </div>
                        </div>
                        <div class="row margin-o">
                            <div class="col-lg-4">
                              <div class="authority-left-single-img overflow-fix"><img src="<?php echo e(asset('makson/images/Capture7.png')); ?>" alt="Title"></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="authority-right-slider owl-carousel owl-theme overflow-fix">
                        <div class="authority-single-profile overflow-fix">
                          <div class="authority-single-profile-content-area overflow-fix">
                            <div class="authority-single-profile-img overflow-fix"><img src="<?php echo e(asset('makson/images/Capture.PNG')); ?>" alt="Title">
                        ...
                        <div class="authority-single-profile overflow-fix">
                          <div class="authority-single-profile-content-area overflow-fix">
                            <div class="authority-single-profile-img overflow-fix"><img src="<?php echo e(asset('makson/images/Capture2.PNG')); ?>" alt="Title">
                              <svg height="0" width="0">
                                <defs>
                                  <clipPath id="authority-img">
                                    <path fill="#FFFFFF" stroke="#000000" stroke-width="0" stroke-miterlimit="10" d="M89.167,195.255 C64.279,151.574 39.139,108.038 13.748,64.647 C-11.643,21.257 0.801,-0.293 51.081,-0.003 C101.360,0.287 151.640,0.287 201.919,-0.003 C252.199,-0.293 264.643,21.257 239.252,64.647 C213.861,108.038 188.721,151.574 163.833,195.255 C138.944,238.936 114.056,238.936 89.167,195.255 Z"></path>
                        ...
                        <div class="authority-single-profile overflow-fix">
                          <div class="authority-single-profile-content-area overflow-fix">
                            <div class="authority-single-profile-img overflow-fix"><img src="<?php echo e(asset('makson/images/Capture3.png')); ?>" alt="Title">
                              <svg height="0" width="0">
                                <defs>
                                  <clipPath id="authority-img">
                                    <path fill="#FFFFFF" stroke="#000000" stroke-width="0" stroke-miterlimit="10" d="M89.167,195.255 C64.279,151.574 39.139,108.038 13.748,64.647 C-11.643,21.257 0.801,-0.293 51.081,-0.003 C101.360,0.287 151.640,0.287 201.919,-0.003 C252.199,-0.293 264.643,21.257 239.252,64.647 C213.861,108.038 188.721,151.574 163.833,195.255 C138.944,238.936 114.056,238.936 89.167,195.255 Z"></path>
                        ...
                        <div class="authority-single-profile overflow-fix">
                          <div class="authority-single-profile-content-area overflow-fix">
                            <div class="authority-single-profile-img overflow-fix"><img src="<?php echo e(asset('makson/images/Capture4.png')); ?>" alt="Title">
                              <svg height="0" width="0">
                                <defs>
                                  <clipPath id="authority-img">
                                    <path fill="#FFFFFF" stroke="#000000" stroke-width="0" stroke-miterlimit="10" d="M89.167,195.255 C64.279,151.574 39.139,108.038 13.748,64.647 C-11.643,21.257 0.801,-0.293 51.081,-0.003 C101.360,0.287 151.640,0.287 201.919,-0.003 C252.199,-0.293 264.643,21.257 239.252,64.647 C213.861,108.038 188.721,151.574 163.833,195.255 C138.944,238.936 114.056,238.936 89.167,195.255 Z"></path>
                        ...
                        <div class="authority-single-profile overflow-fix">
                          <div class="authority-single-profile-content-area overflow-fix">
                            <div class="authority-single-profile-img overflow-fix"><img src="<?php echo e(asset('makson/images/Capture5.png')); ?>" alt="Title">
                              <svg height="0" width="0">
                                <defs>
                                  <clipPath id="authority-img">
                                    <path fill="#FFFFFF" stroke="#000000" stroke-width="0" stroke-miterlimit="10" d="M89.167,195.255 C64.279,151.574 39.139,108.038 13.748,64.647 C-11.643,21.257 0.801,-0.293 51.081,-0.003 C101.360,0.287 151.640,0.287 201.919,-0.003 C252.199,-0.293 264.643,21.257 239.252,64.647 C213.861,108.038 188.721,151.574 163.833,195.255 C138.944,238.936 114.056,238.936 89.167,195.255 Z"></path>
                        ...
                        <div class="authority-single-profile overflow-fix">
                          <div class="authority-single-profile-content-area overflow-fix">
                            <div class="authority-single-profile-img overflow-fix"><img src="<?php echo e(asset('makson/images/Capture6.png')); ?>" alt="Title">
                              <svg height="0" width="0">
                                <defs>
                                  <clipPath id="authority-img">
                                    <path fill="#FFFFFF" stroke="#000000" stroke-width="0" stroke-miterlimit="10" d="M89.167,195.255 C64.279,151.574 39.139,108.038 13.748,64.647 C-11.643,21.257 0.801,-0.293 51.081,-0.003 C101.360,0.287 151.640,0.287 201.919,-0.003 C252.199,-0.293 264.643,21.257 239.252,64.647 C213.861,108.038 188.721,151.574 163.833,195.255 C138.944,238.936 114.056,238.936 89.167,195.255 Z"></path>
                        ...
                        <div class="authority-single-profile overflow-fix">
                          <div class="authority-single-profile-content-area overflow-fix">
                            <div class="authority-single-profile-img overflow-fix"><img src="<?php echo e(asset('makson/images/Capture7.png')); ?>" alt="Title">
                              <svg height="0" width="0">
                                <defs>
                                  <clipPath id="authority-img">
                                    <path fill="#FFFFFF" stroke="#000000" stroke-width="0" stroke-miterlimit="10" d="M89.167,195.255 C64.279,151.574 39.139,108.038 13.748,64.647 C-11.643,21.257 0.801,-0.293 51.081,-0.003 C101.360,0.287 151.640,0.287 201.919,-0.003 C252.199,-0.293 264.643,21.257 239.252,64.647 C213.861,108.038 188.721,151.574 163.833,195.255 C138.944,238.936 114.056,238.936 89.167,195.255 Z"></path>
            ...
            <?php if( $ccount > 0): ?>
              <div class="clientele-slider owl-carousel owl-theme overflow-fix">
                <?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  ...
                  <?php endif; ?>
                  <div class="clientele-slider-single-item-img overflow-fix"><img src="<?php echo e(asset('/uploads/'. $client->logo)); ?>" alt="Title"></div>
