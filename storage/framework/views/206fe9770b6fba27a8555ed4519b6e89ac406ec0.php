                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title"><a href="<?php echo e(route('bulletin.create')); ?>">Create</a></strong>
                        </div>
                        <div class="card-body">
                            <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td><?php echo str_limit(strip_tags($bulletin->description), 30); ?></td>
                                    <td>

                                        <a href="<?php echo e(route('bulletin.edit', $bulletin->id)); ?>">
                                            <button class="btn btn-style btn-small btn-info"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button>
                                        </a>
                                        <?php echo Form::open(['route' => ['bulletin.destroy', $bulletin->id ], 'method' => 'DELETE', 'class'=>'delete_form', 'style'=>'display:inline' ]); ?>
