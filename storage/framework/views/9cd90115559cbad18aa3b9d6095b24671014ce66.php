            ...
            <div class="page-header float-right">
                <div class="page-title">
                    <ol class="breadcrumb text-right">
                        ...
                        <li><a href="<?php echo e(route('dreport.index')); ?>">Director Report</a></li>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                          <form action="<?php echo e(route('dreport.store')); ?>" method="POST" enctype="multipart/form-data" file="true">
