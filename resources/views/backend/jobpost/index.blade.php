                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title"><a href="{{ route('jobpost.create') }}">Create</a></strong>
                        </div>
                        <div class="card-body">
                            <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    <td>{{ $jobpost->title }}</td>
                                    <td>{!! str_limit(strip_tags($jobpost->description), 30) !!}
                                    </td>
                                    <td>
                                        ...
                                        {!! Form::open(['route' => ['jobpost.destroy', $jobpost->id ], 'method' => 'DELETE', 'class'=>'delete_form', 'style'=>'display:inline' ])!!}
